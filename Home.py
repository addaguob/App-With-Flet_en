...
class Home(UserControl):
    def __init__(self, route):
        ...
        self.line_chart = LineChart(
            ...
            top_axis=ChartAxis(
                title=Text("Sales Evolution (R$)", style=TextThemeStyle.TITLE_MEDIUM),
                title_size=30,
        ...
        self.bar_chart = BarChart(
            ...
            top_axis=ChartAxis(
                title=Text(
                    ...
                    tooltip="Products that generated the most profit",
                            ...
                            controls=[
                                Row(
                                    ...
                                    controls=[
                                        ...
                                        Text(value="Registered Customers", size=16),
                                    ],
                                ),
        ...
        self.btn_add_sale = OutlinedButton(
            text="New Sale", icon=icons.ADD_OUTLINED, on_click=self.add_sale_clicked
        )
                            ...
                            controls=[
                                Row(
                                    ...
                                    controls=[
                                        ...
                                        Text(value="Orders Today", size=16),
                                    ],
                                ),
                ...
                content=Column(
                    ...
                    controls=[
                            ...
                            controls=[
                                Row(
                                    ...
                                    controls=[
                                        ...
                                        Text(value="Products Registered", size=16),
                                    ],
                                ),
                        ...
                        Column(
                            ...
                            spacing=0,
                            controls=[
                                Text("Low Stock Products", size=16),
                                Row(
                                    alignment="center",
                                    spacing=0,
                                    controls=[
    ...
    def update_bar_chart(self, data_id, data_value, data_descr):
        if len(data_id) < 1:
            ...
            self.bar_chart.top_axis.title.value = "Most profitable products - no data"
            self.bar_chart.update()
            return

        self.bar_chart.top_axis.title.value = "Most profitable products"
    ...
    def update_products_card(self, numb_of_products, low_stock):
        ...
        if low_stock > 0:
            self.text_low_stock.spans[0].text = " (View)"
        else:
    ...
    def add_customer_clicked(self, e):
        ...
        self.route.bar.set_title("Register New Customer")
    ...
    def add_product_clicked(self, e):
        ...
        self.route.bar.set_title("Register New Product")
        self.route.page.update()
